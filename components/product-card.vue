...
<template>
    ...
    >
      ...
      <div class="flex min-h-0 flex-1 flex-col gap-2 px-4 py-4">
        ...
        <NuxtLink external :to="designerLink" class="flex justify-end text-hovered-link font-bold hover:right-2 cursor-pointer" v-if="(show3dDesignLink ?? false) && designerLink">
