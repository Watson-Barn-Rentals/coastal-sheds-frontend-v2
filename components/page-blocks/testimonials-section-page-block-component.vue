...
<template>
  <Heading 
    ...
    class="mb-4 mx-4"
  />
  <p class="font-title italic text-2xl text-center mb-4 mx-4">
    {{ data.averageRating }} stars across {{ data.totalReviewsCount }} ratings!
  </p>

  <MaxWidthContentWrapper>
    <div class="flex flex-col lg:flex-row gap-8 lg:h-[34rem]">
      <!-- Flip Card -->
      <div class="relative w-full max-w-96 mx-auto lg:w-[40%] flex flex-col gap-4 h-[20rem] my-auto">
        <div 
      ...
      <div class="relative hidden lg:block w-full lg:w-[60%] h-full overflow-hidden">
        <div class="absolute flex flex-wrap justify-center items-center gap-4 h-full z-0">
          <div
          ...
          >
            ...
            <div class="mt-auto text-xs">
              <span>{{ t.authorsName }}</span><span v-if="t.date" class="mx-1">·</span
