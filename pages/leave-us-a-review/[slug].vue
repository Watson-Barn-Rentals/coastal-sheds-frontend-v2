...
import { submitReviewRequestChannelClickedEvent } from "~/services/api/submit-review-request-channel-clicked-event";
...
const shareDescription = computed(
  () => data.value?.template.requestMessage ?? 'We value your feedback—pick your favorite platform to leave a review.'
)
...
const handleChannelClick = (channel: ReviewRequestChannelItem) => {
    if (!data.value) return;

    submitReviewRequestChannelClickedEvent(data.value, channel);
};
</script>
